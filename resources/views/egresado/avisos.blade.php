<x-layouts.app> 
    <div class="min-h-screen bg-gradient-to-b from-[#f9f9f9] to-[#bcbcbc] py-4">
        ...
        <div class="bg-gradient-to-r from-indigo-100 to-blue-100 p-6 rounded-lg shadow-md m-6">
                    ...
                    <li class="flex justify-center items-center">
                        <article class="bg-[#f0f0f0] rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 flex flex-col md:flex-row w-full md:w-[80%] overflow-hidden">
                            <div class="flex justify-center items-center w-full md:w-[40%] bg-gray-100">
                                <img class=" bg-[#f0f0f0] w-full h-auto object-contain p-4" src="{{ asset('storage/' . $aviso->imagen_ruta) }}" alt=""> 
                            </div>
