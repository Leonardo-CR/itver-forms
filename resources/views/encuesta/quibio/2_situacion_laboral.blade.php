        ...
        <!-- Radiobutton Preguntas-->
          <div class="grid gap-0.5 my-0.5 md:grid-cols-1">
              ...
              <div class="flex items-center mb-4">
                  <input required id="ans1" type="radio" value="Si" name="respuesta[s9_p1]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                  <label  for="default-radio-1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Si</label>
              </div>
              <div class="flex items-center">
                  <input required checked id="ans2" type="radio" value="No" name="respuesta[s9_p1]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
...
<div class="my-6 trabajo-si">
    ...
    <div class="grid gap-4 md:grid-cols-1">
        ...
        <div class="flex items-center">
            <input id="radio-no-consigo" type="radio" value="Aún no lo consigo" name="respuesta[s9_p4]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
