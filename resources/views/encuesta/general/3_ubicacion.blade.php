...
<div href="#" class=" block mx-auto my-auto w-full text-black  max-w-2xl p-6 bg-white border border-gray-200 rounded-lg shadow-sm  dark:bg-gray-800 ">
    ...
    <form>
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans1" type="radio" value="1" name="respuesta[s3_p1]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Trabaja</label>
          </div>
          <div>
            <input id="ans2" type="radio" value="2" name="respuesta[s3_p1]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Estudia</label>
          </div>
          <div>
            <input id="ans3" type="radio" value="3" name="respuesta[s3_p1]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans3" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Estudia y trabaja</label>
          </div>
          <div>
            <input id="ans4" type="radio" value="4" name="respuesta[s3_p1]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans5" type="radio" value="1" name="respuesta[s3_p2]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans5" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Especialidad</label>
          </div>
          <div>
            <input id="ans6" type="radio" value="2" name="respuesta[s3_p2]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans6" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Maestria</label>
          </div>
          <div>
            <input id="ans7" type="radio" value="3" name="respuesta[s3_p2]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans7" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Doctorado</label>
          </div>
          <div>
            <input id="ans8" type="radio" value="4" name="respuesta[s3_p2]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans9" type="radio" value="1" name="respuesta[s3_p5]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans9" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Antes de Egresar</label>
          </div>
          <div>
            <input id="ans10" type="radio" value="2" name="respuesta[s3_p5]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans10" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Menos de seis meses</label>
          </div>
          <div>
            <input id="ans11" type="radio" value="3" name="respuesta[s3_p5]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans11" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Entre seis meses y un año</label>
          </div>
          <div>
            <input id="ans12" type="radio" value="4" name="respuesta[s3_p5]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans13" type="radio" value="1" name="respuesta[s3_p6]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans13" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Bolsa de trabajo del plantel</label>
          </div>
          <div>
            <input id="ans14" type="radio" value="2" name="respuesta[s3_p6]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans14" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Contactos personales</label>
          </div>
          <div>
            <input id="ans15" type="radio" value="3" name="respuesta[s3_p6]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans15" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Residencia Profesional</label>
          </div>
          <div>
            <input id="ans16" type="radio" value="4" name="respuesta[s3_p6]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    ...
    <div class="mb-6">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans1" type="radio" value="1" name="respuesta[s3_p8]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Competencias laborales</label>
          </div>
          <div>
            <input id="ans2" type="radio" value="2" name="respuesta[s3_p8]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Título Profesional</label>
          </div>
          <div>
            <input id="ans3" type="radio" value="3" name="respuesta[s3_p8]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans3" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Examen de selección</label>
          </div>
          <div>
            <input id="ans4" type="radio" value="4" name="respuesta[s3_p8]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans4" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Idioma Extranjero</label>
          </div>
          <div>
            <input id="ans5" type="radio" value="5" name="respuesta[s3_p8]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
          ...
          <div>
            <input id="ans6" type="radio" value="6" name="respuesta[s3_p8]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans7" type="radio" value="1" name="respuesta[s3_p10]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans7" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Inglés</label>
          </div>
          <div>
            <input id="ans8" type="radio" value="2" name="respuesta[s3_p10]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans8" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Francés</label>
          </div>
          <div>
            <input id="ans9" type="radio" value="3" name="respuesta[s3_p10]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans9" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Alemán</label>
          </div>
          <div>
            <input id="ans10" type="radio" value="4" name="respuesta[s3_p10]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-4">
          <div>
            ...
            <div class="flex w-full gap-4">
              <input type="text" id="hablar" name="respuesta[s3_p12]" class="basis-[90%] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="50" required />
          ...
          <div>
            ...
            <div class="flex w-full gap-4">
              <input type="text" id="escribir" name="respuesta[s3_p13]" class="basis-[90%] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="10" required />
              <span class="basis-[10%] mb-2 text-sm font-medium text-gray-900 dark:text-white">%</span>
            </div>          
          </div>
          <div>
            ...
            <div class="flex w-full gap-4">
              <input type="text" id="leer" name="respuesta[s3_p14]" class="basis-[90%] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="20" required />
              <span class="basis-[10%] mb-2 text-sm font-medium text-gray-900 dark:text-white">%</span>
            </div>
          </div>
          <div>
            ...
            <div class="flex w-full gap-4">
              <input type="text" id="escuchar" name="respuesta[s3_p15]" class="basis-[90%] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="20" required />
              <span class="basis-[10%] mb-2 text-sm font-medium text-gray-900 dark:text-white">%</span>
            </div>          
          </div>
        </div>
    ...
    <div class="mb-6">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans1" type="radio" value="1" name="respuesta[s3_p16]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Menos de un año</label>
          </div>
          <div>
            <input id="ans2" type="radio" value="2" name="respuesta[s3_p16]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Un año</label>
          </div>
          <div>
            <input id="ans3" type="radio" value="3" name="respuesta[s3_p16]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans3" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Dos años</label>
          </div>
          <div>
            <input id="ans4" type="radio" value="4" name="respuesta[s3_p16]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans4" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tres Años</label>
          </div>
          <div>
            <input id="ans5" type="radio" value="5" name="respuesta[s3_p16]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      ...
      <div class="mb-4">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans6" type="radio" value="1" name="respuesta[s3_p18]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans6" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Menos de cinco</label>
          </div>
          <div>
            <input id="ans7" type="radio" value="2" name="respuesta[s3_p18]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans7" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Entre cinco y siete</label>
          </div>
          <div>
            <input id="ans8" type="radio" value="3" name="respuesta[s3_p18]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans8" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Entre 8 y 10</label>
          </div>
          <div>
            <input id="ans9" type="radio" value="4" name="respuesta[s3_p18]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      ...
      <div class="mb-4">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans10" type="radio" value="1" name="respuesta[s3_p19]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans10" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Técnico</label>
          </div>
          <div>
            <input id="ans11" type="radio" value="2" name="respuesta[s3_p19]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans11" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Supervisor</label>
          </div>
          <div>
            <input id="ans12" type="radio" value="3" name="respuesta[s3_p19]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans12" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Jefe de área</label>
          </div>
          <div>
            <input id="ans13" type="radio" value="4" name="respuesta[s3_p19]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans13" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Funcionario</label>
          </div>
          <div>
            <input id="ans14" type="radio" value="5" name="respuesta[s3_p19]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans14" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Directivo</label>
          </div>
          <div>
            <input id="ans15" type="radio" value="6" name="respuesta[s3_p19]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      ...
      <div class="mb-4">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans16" type="radio" value="1" name="respuesta[s3_p20]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans16" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Base</label>
          </div>
          <div>
            <input id="ans17" type="radio" value="2" name="respuesta[s3_p20]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans17" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Eventual</label>
          </div>
          <div>
            <input id="ans18" type="radio" value="3" name="respuesta[s3_p20]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    ...
    <div class="mb-6">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans1" type="radio" value="1" name="respuesta[s3_p22]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">0%</label>
          </div>
          <div>
            <input id="ans2" type="radio" value="2" name="respuesta[s3_p22]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">20%</label>
          </div>
          <div>
            <input id="ans3" type="radio" value="3" name="respuesta[s3_p22]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans3" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">40%</label>
          </div>
          <div>
            <input id="ans4" type="radio" value="4" name="respuesta[s3_p22]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans4" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">60%</label>
          </div>
          <div>
            <input id="ans5" type="radio" value="5" name="respuesta[s3_p22]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans5" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">80%</label>
          </div>
          <div>
            <input id="ans6" type="radio" value="6" name="respuesta[s3_p22]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans7" type="radio" value="1" name="respuesta[s3_p23]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans7" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Publico</label>
          </div>
          <div>
            <input id="ans8" type="radio" value="2" name="respuesta[s3_p23]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans8" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Privado</label>
          </div>
          <div>
            <input id="ans9" type="radio" value="3" name="respuesta[s3_p23]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
    ...
    <div class="mb-6">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans1" type="radio" value="1" name="respuesta[s3_p39]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans1" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Agroindustria</label>
          </div>
          <div>
            <input id="ans2" type="radio" value="2" name="respuesta[s3_p39]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans2" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pesquero</label>
          </div>
          <div>
            <input id="ans3" type="radio" value="3" name="respuesta[s3_p39]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans3" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Minero</label>
          </div>
          <div>
            <input id="ans4" type="radio" value="4" name="respuesta[s3_p39]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans5" type="radio" value="1" name="respuesta[s3_p40]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans5" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Industrial</label>
          </div>
          <div>
            <input id="ans6" type="radio" value="2" name="respuesta[s3_p40]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans6" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Construcción</label>
          </div>
          <div>
            <input id="ans7" type="radio" value="3" name="respuesta[s3_p40]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans7" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Petrolero</label>
          </div>
          <div>
            <input id="ans8" type="radio" value="4" name="respuesta[s3_p40]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans9" type="radio" value="1" name="respuesta[s3_p41]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans9" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Educativo</label>
          </div>
          <div>
            <input id="ans10" type="radio" value="2" name="respuesta[s3_p41]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans10" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Turismo</label>
          </div>
          <div>
            <input id="ans11" type="radio" value="3" name="respuesta[s3_p41]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans11" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Comercio</label>
          </div>
          <div>
            <input id="ans12" type="radio" value="4" name="respuesta[s3_p41]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans12" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Servicios Financieros</label>
          </div>
          <div>
            <input id="ans13" type="radio" value="5" name="respuesta[s3_p41]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
      ...
      <div class="mb-6">
        ...
        <div class="flex flex-col mb-4 sexo">
          <div>
            <input id="ans14" type="radio" value="1" name="respuesta[s3_p42]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans14" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Microempresa (1-30)</label>
          </div>
          <div>
            <input id="ans15" type="radio" value="2" name="respuesta[s3_p42]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans15" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Pequeña (31-100)</label>
          </div>
          <div>
            <input id="ans16" type="radio" value="3" name="respuesta[s3_p42]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
            <label for="ans16" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Mediana (101-500)</label>
          </div>
          <div>
            <input id="ans17" type="radio" value="4" name="respuesta[s3_p42]" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
