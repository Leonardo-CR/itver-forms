    ...
    <div class="my-6">
        ...
        <div class="grid gap-4 md:grid-cols-1">
          <div class="w-full flex items-center gap-20">
            ...
            <select class="w-52 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
          ...
          <div class="w-full flex items-center gap-20">
            ...
            <select class="w-52 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
              <option selected>Selecciona una opción</option>
              <option value="5">Demasiado (5)</option>
              <option value="4">Mucho (4)</option>
              <option value="3">Más o menos (3)</option>
