...
class PerfilEgresadoController extends Controller
{
    ...
    public function guardarDatosGenerales(Request $request)
    {
        $val = $request->validate([
            ...
            'ap_paterno' => 'nullable|string|max:80',
            'ap_materno' => 'nullable|string|max:80',
            'fecha_nac' => 'nullable|date',
            'sexo' => 'nullable|in:Masculino,Femenino',
            'curp' => 'nullable|string|size:13',
            ...
            'red_social' => 'nullable|string|max:50',
            'no_control' => 'nullable|string|max:10',
            'titulado' => 'nullable|integer',
            'dominio_ingles' => 'nullable|integer|min:0|max:100',
            'manejo_paquetes' => 'nullable|string',
            'obstaculo' => 'nullable|string|max:80',
            'explicate' => 'nullable|string|max:80',
